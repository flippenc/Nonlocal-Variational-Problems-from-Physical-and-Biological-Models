function genModel = parameterizedGenModelLambda2(alpha,beta,gamma,delta,epsilon,lambda,a,b,N,tMax)
...
for i=0:m
    ...
    if ~(any(isnan(xcol)) || any(isnan(ycol)))        
        ...
        hold on
        t = linspace(0,2*pi);
        ellipseX = (sqrt(epsilon)/a)*cos(t);
        ellipseY = (sqrt(epsilon)/b)*sin(t);
